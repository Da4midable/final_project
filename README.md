...
Installation
To run the Formidable Quiz locally, follow these steps:
...
Configure the database: Run the SQL schema to create the necessary tables:
...
Copy code
flask run
Access the application: Open your browser and navigate to http://127.0.0.1:5000 to view the quiz app.
